...
public class Simulation extends Application{
	...
	public void changeLights(ObservableList<Node> rootNodeList)
	{
		...
		if(this.oneIntersection.get(0).stoplight.lights[1] == 0) {
			if(this.oneIntersection.get(0).stoplight.lights[3] == 1) {
				System.out.println("GR");
				this.level_map.drawGRInt(root.getChildren());				
			}
		}
		if(this.oneIntersection.get(0).stoplight.lights[3] == 2) {		
			if(this.oneIntersection.get(0).stoplight.lights[1] == 0) {
				System.out.println("YR");
				this.level_map.drawYRInt(root.getChildren());				
			}
		}
		else if(this.oneIntersection.get(0).stoplight.lights[1] == 1) {		
			if(this.oneIntersection.get(0).stoplight.lights[3] == 0) {
				System.out.println("RG");
				this.level_map.drawRGInt(root.getChildren());				
			}
		}
		else if(this.oneIntersection.get(0).stoplight.lights[1] == 2) {		
			if(this.oneIntersection.get(0).stoplight.lights[3] == 0) {
				System.out.println("RY");
				this.level_map.drawRYInt(root.getChildren());				
			}
		}	
//		else {
//			System.out.println("YR");
//			this.level_map.drawYRInt(root.getChildren());
//		}
		System.out.println("l " + this.oneIntersection.get(0).stoplight.lights[0]);
		System.out.println("r " + this.oneIntersection.get(0).stoplight.lights[1]);			
		System.out.println("u " + this.oneIntersection.get(0).stoplight.lights[2]);
		System.out.println("d " + this.oneIntersection.get(0).stoplight.lights[3]);
